...
ARG PUBLIC_SITE_URL=https://www.pixeldesk.in
ARG PUBLIC_ALT_SITE_URL=https://www.thepixeldesk.com
ARG PUBLIC_ORG_SAME_AS=
...
ENV PUBLIC_ALT_SITE_URL=$PUBLIC_ALT_SITE_URL
ENV PUBLIC_ORG_SAME_AS=$PUBLIC_ORG_SAME_AS
